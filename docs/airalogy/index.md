...
- Language landing page: `docs/airalogy/index.md`
- Sidebar config: `docs/airalogy/.vitepress/sidebars/`
...
2. **Update both languages together**
   Whenever you add or change a feature, edit the corresponding pages in **both** `docs/airalogy/en` and `docs/airalogy/zh` before merging.
