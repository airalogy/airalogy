...
- [英文文档](https://airalogy.github.io/airalogy/airalogy/en/)
- [中文文档](https://airalogy.github.io/airalogy/airalogy/zh/)
- [文档编写规范](https://github.com/airalogy/airalogy/tree/main/docs/airalogy/index.md)
...
`files.json` 里的相对 `path`、`local_path` 或 `file_path` 会相对于该 spec 文件自身解析。
...
参见文档：`docs/airalogy/en/apis/convert.md` / `docs/airalogy/zh/apis/convert.md`。
