...
<template>
  ...
  >
    <AimdRecorder
      ...
      :quiz-grades="surfaceState.quizGrades"
      :submitted="surfaceState.submitted"
      :choice-option-explanation-mode="surfaceState.choiceOptionExplanationMode"
      :scale-grade-display-mode="surfaceState.scaleGradeDisplayMode"
      ...
      :collector-record-key="surfaceState.collectorRecordKey"
      :protocol-context="surfaceState.protocolContext"
      :resolve-file="surfaceState.resolveFile"
      :resolve-file-info="surfaceState.resolveFileInfo"
      :upload-file="surfaceState.uploadFile"
      :run-server-assigner="surfaceState.runServerAssigner"
      :assigner-runner="surfaceState.assignerRunner"
