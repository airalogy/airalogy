...
- fb10659: Add native Record table show-all and restore-default column actions with independent host defaults, bilingual labels, and controlled selection events.
